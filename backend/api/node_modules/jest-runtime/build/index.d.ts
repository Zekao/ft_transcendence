 ...
 */
import type { JestEnvironment } from '../../@jest/environment/build';
import type * as JestGlobals from '../../@jest/globals/build';
import type { SourceMapRegistry } from '../../@jest/source-map/build';
import type { V8CoverageResult } from '../../@jest/test-result/build';
import { CallerTransformOptions, ScriptTransformer, ShouldInstrumentOptions, shouldInstrument } from '../../@jest/transform/build';
import type { Config, Global } from '@jest/types';
import type { IModuleMap } from '../../jest-haste-map/build';
import HasteMap from '../../jest-haste-map/build';
import Resolver from '../../jest-resolve/build';
