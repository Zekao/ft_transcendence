...
export class ChannelsService {
  ...
  async addUserToMember(me: string, channelId: string, channelMembers: ChannelMembersDto) : Promise<User> {
  ...
  async addUserToAdmin(me: string, channelId: string, channelMembers: ChannelMembersDto) : Promise<User> {
    const { user } = channelMembers;
    if (user)
      me = user;
  ...
  async addUserToMuted(me: string, channelId: string, channelMembers: ChannelMembersDto) : Promise<User> {
    const { user } = channelMembers;
    if (user)
      me = user;
    const found = await this.UsersService.getUserId(me);
  ...
  async addUserToBanned(me: string, channelId: string, channelMembers: ChannelMembersDto) : Promise<User> {
    const { user } = channelMembers;
    if (user)
      me = user;
    const found = await this.UsersService.getUserId(me);
